  ...
  <div>
    <div className="bg-gray-100 grid lg:grid-cols-2 2xl:grid-cols-5">
      <div className="px-8 py-12 max-w-md mx-auto sm:max-w-xl lg:px-12 lg:py-24 lg:max-w-full xl:mr-0 2xl:col-span-2">
        <div className="xl:max-w-xl">
          <img className="h-10" src="/public/images/logo-brand.svg" alt="Workcation" />
          <img className="mt-6 rounded-lg shadow-xl sm:mt-8 sm:h-64 sm:w-full sm:object-cover object-center lg:hidden"
            src="/public/images/beach-work.jpg" alt="Woman workcationing on the beach" />
          <h1 
          ...
          <div className="mt-4 space-x-1 sm:mt-6">
            ...
            bg-brand hover:bg-brand-light hover:-translate-y-0.5 focus:ring-brand-dark 
              focus:ring-opacity-50 focus:outline-none focus:ring focus:ring-offset-2 
    ...
    <div className="max-w-md sm:max-w-xl lg:max-w-6xl mx-auto px-8 lg:px-12 py-8">
      ...
      <div className="mt-6 grid gap-6 lg:grid-cols-2 xl:grid-cols-3">
        ...
        <Card v-for="place in popularDestinations" :key="place.id" :place="place" />
...
// 2. Importar los datos de la lista
